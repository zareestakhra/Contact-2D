function [KC, KE, A, B, C] = static_reduction_Restricted(K, ...
    internal_nodes, ext_loaded_nodes, contact_nodes, load_type,...
    internal_intersect_DOF, ext_intersect_DOF, contact_intersect_DOF)
% 
...
KII(internal_intersect_DOF,:)=[];
KII(:,internal_intersect_DOF)=[];

%%
KIE = K(internal_nodes, ext_loaded_nodes);
KIE(internal_intersect_DOF,:)=[];
KIE(:,ext_intersect_DOF)=[];
...
KIC(internal_intersect_DOF,:)=[];
KIC(:,contact_intersect_DOF)=[];
...
KEE(ext_intersect_DOF,:)=[];
KEE(:,ext_intersect_DOF)=[];

%%
KEC = K(ext_loaded_nodes, contact_nodes);
KEC(ext_intersect_DOF,:)=[];
KEC(:,contact_intersect_DOF)=[];
