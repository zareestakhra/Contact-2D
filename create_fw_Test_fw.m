function [load_distribution] = create_fw_Test_fw( KE, ...
    load_distribution_x, load_distribution_y, timestep_number, Number_of_timesteps )
...
T=linspace(0.0001,1, Number_of_timesteps);
