...
if ~isempty(intersect(Anodes_contact_bodyT,RestrictionFixed))
    ...
    [Contact_Intersect_DOF]=DOF_Maker_6(Contact_Intersect);
else
...
if ~isempty(intersect(Anodes_ext_loadedT,RestrictionFixed))
    ...
    [Ext_Load_Intersect_DOF]=DOF_Maker_6(Ext_Load_Intersect);
else
...
if ~isempty(intersect(Anodes_internalT,RestrictionFixed))
    ...
    [internal_Intersect_DOF]=DOF_Maker_6(internal_Intersect);
else
